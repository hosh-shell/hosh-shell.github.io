...
Binary releases:
 - [v0.2.0 - 2023-12-31](https://github.com/hosh-shell/hosh/releases/download/v0.1.4/hosh-0.2.0.jar) \[[with GPG signature](https://github.com/hosh-shell/hosh/releases/download/v0.2.0/hosh-0.2.0.jar.asc)\]
